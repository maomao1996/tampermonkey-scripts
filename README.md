...
| [115 小助手](#115-helper-115-小助手)                                                                                  | ![115 小助手](https://img.shields.io/greasyfork/v/413142)                 | 115 网盘体验增强（还原顶部菜单栏链接任务入口、一键搜索、SHA1 快速查重/自动查重、删除空文件夹、列表显示文件 SHA1 信息）                                                                                                   | [GreasyFork](https://greasyfork.org/zh-CN/scripts/413142)<br />[GitHub](https://github.com/maomao1996/tampermonkey-scripts/raw/gh-pages/115-helper/115-helper.user.js)<br />[pages.dev](https://tampermonkey-scripts.pages.dev/115-helper/115-helper.user.js) |
