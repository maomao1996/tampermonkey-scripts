...
!function() {
  ...
  } ], i = [ "FreeBuf \u7f51\u7edc\u5b89\u5168\u884c\u4e1a\u95e8\u6237", "freebuf.com", {
    script: function() {
  ...
  function f(t, e) {
    return function(t) {
      ...
      if (null != o) {
        var r, i, n = [], a = !0, l = !1;
        try {
          for (o = o.call(t); !(a = (r = o.next()).done) && (n.push(r.value), !e || n.length !== e); a = !0) ;
        } catch (t) {
          l = !0, i = t;
        } finally {
          try {
  ...
  var v = Object.values(m).find((function(e) {
    var o = f(e, 2)[1];
