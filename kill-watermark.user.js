...
// @description 杀死水印（移除烦人的水印，还你一个干净清爽的页面）；已适配360 智脑、腾讯文档、飞书、FreeBuf 网络安全行业门户、稿定设计、爱奇艺播放页（右上角 logo、暂停时的广告）、腾讯课堂播放页漂浮水印、哔哩哔哩直播左上角 logo、CSDN C 知道、腾讯视频播放页（右上角 logo、暂停时的弹窗广告）、优酷播放页 logo、语雀
...
!function() {
  "use strict";
  var t = "undefined" != typeof window ? location.hostname.replace(/^www\./, "") : "", e = [ "360 \u667a\u8111", "chat.360.com", {
  ...
  var v = Object.values(c).find((function(e) {
    var o = f(e, 2)[1];
    return "string" == typeof o ? t.includes(o) : o.test(t);
  }));
  if (v) {
    var g = v[2], b = g.style, h = g.script;
    b && GM_addStyle(b), "function" == typeof h && h();
  }
}();
